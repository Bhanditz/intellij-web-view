 ...
 * @author max
 */
public class MyLocalInspectionPass extends ProgressableTextEditorHighlightingPass implements DumbAware {
    ...
    public MyLocalInspectionPass(@NotNull PsiFile file,
        ...
        // super(file, document, startOffset, endOffset, priorityRange, ignoreSuppressed);
    ...
    private void inspect(@NotNull final List<LocalInspectionToolWrapper> toolWrappers,
        ...
        List<LocalInspectionTool> tools = getToolsForElements(toolWrappers, checkDumbAwareness, inside, outside);
    ...
    private static List<LocalInspectionTool> getToolsForElements(List<LocalInspectionToolWrapper> toolWrappers,
                                                                 boolean checkDumbAwareness,
    ...
    private void addHighlightsFromResults(@NotNull List<HighlightInfo> outInfos, ProgressIndicator indicator) {
        InspectionProfile inspectionProfile = InspectionProjectProfileManager.getInstance(myProject).getInspectionProfile();
        PsiDocumentManager documentManager = PsiDocumentManager.getInstance(myProject);
        InjectedLanguageManager ilManager = InjectedLanguageManager.getInstance(myProject);
        Set<TextRange> emptyActionRegistered = new THashSet<TextRange>();
